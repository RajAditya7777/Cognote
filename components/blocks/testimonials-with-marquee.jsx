...
export function TestimonialsSection({
  ...
  return (
    <section
      className={cn("bg-black text-white", "py-12 sm:py-24 md:py-32 px-0", className)}>
      <div
        ...
        <div
          ...
          <div
            className="pointer-events-none absolute inset-y-0 left-0 hidden w-1/3 bg-gradient-to-r from-black sm:block" />
          <div
            className="pointer-events-none absolute inset-y-0 right-0 hidden w-1/3 bg-gradient-to-l from-black sm:block" />
        </div>
      </div>
    </section>
  );
